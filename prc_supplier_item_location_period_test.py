...
SCOPE_PK = ["item_id", "location_id", "supplier_id"]
RESULT_TABLE = 'result_supplier_item_location_period_spark'
NORM_SCOPE_TABLE = "supplier_item_location_period_norm"
ORIGINAL_SCOPE_TABLE = "supplier_item_location_period"
...
def main(current_metric_id: int):
    """Main processing pipeline for the supplier_item_location_period scope."""
    ...
    intersections_df = find_intersections(
        supplier_item_location_period_norm_df=dfs[NORM_SCOPE_TABLE],
